class SceneMain extends Phaser.Scene {
  ...
  create() {
    ...
    this.background = this.add.tileSprite(0, 0, 600, 1203, "sprBg0")
      .setOrigin(0)
      .setScrollFactor(0, 1); 
    this.backgrounds = [];
    for (var i = 0; i < 5; i++) {
    ...
    this.time.addEvent({
      ...
      callback: function() {
        ...
        if (Phaser.Math.Between(0, 10) >= 1) {
          ...
          if (this.getEnemiesByType("ChaserSpirit").length < 5) {
    
            enemy = new ChaserSpirit(
              this,
              Phaser.Math.Between(0, this.game.config.width),
              0
            );
